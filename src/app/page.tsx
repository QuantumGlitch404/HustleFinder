      ...
      <section className="container mx-auto px-4 w-full bg-secondary/30 py-10 sm:py-12 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-start">
          <div className="flex flex-col items-center text-center p-4">
            <Image src="https://placehold.co/150x150.png" alt="Step 1: Browse or Ask AI" width={150} height={150} className="rounded-full mb-4 shadow-md" data-ai-hint="search browse" />
