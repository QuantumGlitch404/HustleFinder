...
import { 
  ...
  AlertTriangle,
  MessageSquarePlus,
  KeyRound // Added KeyRound for consistency
} from 'lucide-react';
...
export default function HustleDetailsPage({ params }: HustleDetailsPageProps) {
  ...
  const [showStartingGuide, setShowStartingGuide] = useState(true); // Default to true
  ...
  // Determine if we should show the in-page navigation
  // We show it if the starting guide details are visible.
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <div className="flex flex-col lg:flex-row lg:gap-8">
        ...
        <main className="w-full lg:flex-grow min-w-0"> {/* Added min-w-0 for flexbox shrinking issues */}
            ...
            <CardContent className="p-6 pt-8" id="about-hustle">
            ...
            {showStartingGuide && (
              <section aria-labelledby="starting-guide-heading" id="starting-guide-content" className="bg-secondary/10"> 
                ...
                <div className="p-6 space-y-8">
                  ...
                  <div className="p-4 rounded-lg border bg-card shadow-sm" id="steps-to-start">
                  ...
                  <div className="p-4 rounded-lg border bg-card shadow-sm" id="proof-resources">
                    <h3 className="text-xl font-semibold text-primary mb-4 flex items-center">
                  ...
                  <div className="p-4 rounded-lg border bg-card shadow-sm" id="success-tip">
                    <h3 className="text-xl font-semibold text-primary mb-4 flex items-center">
                  ...
                  <div className="p-4 rounded-lg border bg-card shadow-sm" id="what-to-learn">
                    <h3 className="text-xl font-semibold text-primary mb-4 flex items-center">
                  ...
                  <Card className="shadow-md rounded-lg" id="key-info">
                    <CardHeader>
                      <CardTitle className="flex items-center text-2xl text-primary">
                        <KeyRound className="h-6 w-6 mr-3" /> {/* Using KeyRound */}
                        Key Information
                      </CardTitle>
                    </CardHeader>
