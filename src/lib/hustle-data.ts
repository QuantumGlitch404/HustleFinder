...
const remoteCategoriesBatch10 = [
  { name: 'Remote Data Annotation', imageHint: 'data annotation ai' },
  { name: 'Content & Language Tasks', imageHint: 'language content tasks' },
  { name: 'Simple Web & IT Support', imageHint: 'web it support' },
  { name: 'Beginner Marketing & Sales', imageHint: 'marketing sales beginner' },
  { name: 'Virtual Community & Support', imageHint: 'virtual community support' },
  { name: 'Entry-Level Creative Gigs', imageHint: 'creative gigs entry' },
  { name: 'Micro E-commerce & Retail', imageHint: 'ecommerce micro retail' },
  { name: 'Personal & Admin Assistance', imageHint: 'personal admin assistance' },
];

const remoteSampleTitlesBatch10 = [
  // Remote Data Annotation (15)
  'Image Bounding Box Annotation', 'Audio Segmentation for AI', 'Text Categorization for Machine Learning',
  'Named Entity Recognition (NER) in Text', 'Video Object Tracking Annotation', 'Semantic Segmentation of Images',
  'Sentiment Analysis Tagging', 'Lidar 3D Point Cloud Annotation', 'Medical Image Annotation (e.g., X-rays)',
  'Invoice and Receipt Data Extraction', 'Legal Document Clause Identification', 'Product Review Aspect Tagging',
  'Conversation Data Annotation for Chatbots', 'AI Training Data Validation', 'OCR Transcription and Correction',
  // Content & Language Tasks (15)
  'Translation Quality Evaluation', 'Bilingual Glossary Creation', 'Proofreading Machine-Translated Text',
  'Creating Language Learning Flashcards', 'Voice-over for eLearning Modules', 'Transcription of Focus Group Discussions',
  'Writing FAQs for Products/Services', 'Summarizing Technical Documents', 'Content Adaptation for Different Regions',
  'Localizing Social Media Captions', 'Keyword Research for Local SEO', 'Writing Meta Descriptions for Web Pages',
  'Generating Simple Blog Post Ideas', 'Fact-checking for News Articles', 'Creating Subtitles for Internal Corporate Videos',
  // Simple Web & IT Support (15)
  'Basic WordPress Theme Customization', 'Setting up Google Analytics Goals', 'Testing for Cross-Browser Compatibility',
  'Managing DNS Records (Basic)', 'Troubleshooting Basic Email Delivery Issues', 'Helping Users with 2-Factor Authentication Setup',
  'Providing Tier 1 Helpdesk Support', 'Updating Online Knowledge Bases', 'Software Bug Reproduction and Reporting',
  'Assisting with Cloud File Migration', 'Basic Mobile App Testing (iOS/Android)', 'Creating Simple How-To Screencasts',
  'Monitoring Website Uptime', 'Cleaning Malware from Simple Websites', 'Assisting with Data Backups',
  // Beginner Marketing & Sales (15)
  'Creating Simple Email Marketing Templates', 'Building Outreach Lists for Link Building', 'Managing a Small Affiliate Network',
  'Finding and Vetting Potential Influencers', 'Monitoring Competitor Social Media Ads', 'Setting Up Basic Social Media Shops',
  'Engaging in Niche Online Communities', 'Assisting with A/B Testing for Landing Pages', 'Collecting Customer Testimonials',
  'Distributing Content to Social Bookmarking Sites', 'Basic Lead Qualification', 'Assisting with Webinar Setup and Promotion',
  'Creating and Managing Simple Online Polls', 'Monitoring Google Alerts for Keywords', 'Submitting Business to Local Directories',
  // Virtual Community & Support (15)
  'Moderating User Comments on a Blog', 'Managing a Facebook Group (Approving Posts)', 'Welcoming New Members to a Forum',
  'Answering Common Questions on Discord', 'Running a Weekly Q&A Thread on Reddit', 'Identifying and Reporting Spam/Abuse',
  'Encouraging Participation in Online Events', 'Collecting Community Feedback and Suggestions', 'Hosting Virtual Social Events',
  'Creating a "Member of the Week" Feature', 'Managing and Enforcing Community Rules', 'Facilitating Online Support Groups',
  'Providing Peer-to-Peer Support', 'Organizing Virtual Game Nights', 'Curating and Sharing Relevant Content',
  // Entry-Level Creative Gigs (15)
  'Creating Simple Animated Logos (Online Tools)', 'Designing Printable Planners and Checklists', 'Making Photo Collages for Events',
  'Customizing Social Media Templates', 'Finding Stock Photos for Presentations', 'Creating Basic Infographics (Template-based)',
  'Designing YouTube End Screens', 'Creating Simple Pattern Designs for Fabrics', 'Making Custom Emojis for Discord/Slack',
  'Writing Short Jingles or Slogans', 'Basic Sound Editing (Noise Reduction)', 'Creating Animated GIFS from Clips',
  'Designing Custom Digital Greeting Cards', 'Coloring Black and White Photos', 'Creating Lo-fi Music Mixes for Study/Relaxation',
  // Micro E-commerce & Retail (15)
  'Sourcing Products from Alibaba/1688', 'Writing SEO-friendly Etsy Product Titles', 'Optimizing Amazon Product Listings',
  'Handling Customer Returns and Exchanges', 'Managing Inventory Levels Across Platforms', 'Creating Product Bundles for Promotion',
  'Responding to Customer Reviews and Feedback', 'Finding and Collaborating with Dropshippers', 'Running Flash Sales and Promotions',
  'Setting Up and Managing a Wishlist Feature', 'Fulfilling Orders from a Shopify Store', 'Researching Niche E-commerce Markets',
  'Cross-selling and Upselling Product Recommendations', 'Managing a Customer Loyalty Program', 'Analyzing Abandoned Carts and Improving Checkout',
  // Personal & Admin Assistance (15)
  'Organizing and Tagging Digital Photos', 'Managing Personal Calendars and Appointments', 'Transcribing Personal Audio Notes',
  'Researching and Booking Travel', 'Managing Personal Email Inboxes', 'Creating and Managing Household Budgets',
  'Assisting with Online Grocery Shopping', 'Finding and Hiring Local Service Providers', 'Managing Digital Subscriptions',
  'Paying Personal Bills Online', 'Organizing Digital Documents and Files', 'Planning and Coordinating Personal Events',
  'Sending Gifts and Cards for Occasions', 'Proofreading Personal Correspondence', 'Creating Personalized "How-To" Guides for Family',
];

const remoteSampleDescriptionsBatch10 = [
  // Remote Data Annotation (15)
  'Draw precise boxes around objects in images (e.g., cars, pedestrians, products) to train computer vision models.',
  'Listen to audio recordings and mark the start and end times of different sounds or speakers for AI training.',
  'Read sentences or paragraphs and assign them to predefined categories (e.g., spam, not spam) for machine learning.',
  'Identify and tag specific entities like names, dates, and locations in text for natural language processing (NLP) models.',
  'Annotate the movement of objects across multiple video frames to train object tracking algorithms.',
  'Assign a category to every pixel in an image (e.g., road, sky, building) for detailed scene understanding.',
  'Analyze text and label it with the appropriate sentiment (positive, negative, neutral) for market research AI.',
  'Label objects in 3D data from Lidar sensors, commonly used for autonomous vehicle training.',
  'Identify and outline tumors, organs, or anomalies in medical scans to assist in training diagnostic AI tools.',
  'Extract key information like vendor name, date, and total amount from scanned invoices and receipts.',
  'Review legal contracts and tag specific clauses, such as termination or liability, for legal tech AI.',
  'Read product reviews and identify and tag specific aspects being discussed (e.g., "battery life," "screen quality").',
  'Label and structure conversations to train and improve the performance of customer service chatbots.',
  'Review data that has been annotated by AI or other humans to check for accuracy and make corrections.',
  'Transcribe text from images (Optical Character Recognition) and correct any errors made by the AI.',
  // Content & Language Tasks (15)
  'Evaluate the quality of translated text, checking for accuracy, fluency, and cultural appropriateness.',
  'Create a bilingual list of industry-specific terms and their translations for consistent use in documents.',
  'Review text that has been automatically translated by software and correct any grammatical or contextual errors.',
  'Create digital flashcards with words, definitions, and example sentences for language learning apps.',
  'Record clear and professional voice-overs for online courses, training videos, and educational content.',
  'Transcribe audio recordings of market research focus groups, ensuring accuracy for analysis.',
  'Write clear and concise answers to frequently asked questions about a company\'s products or services.',
  'Read long, complex technical documents and create short, easy-to-understand summaries.',
  'Adapt existing content (text, images, tone) to make it culturally relevant and appropriate for different regions.',
  'Translate social media captions from English to a local language, maintaining the original tone and intent.',
  'Research keywords and phrases in a local language that people use to search for specific products or services.',
  'Write concise, keyword-rich meta descriptions that appear in search engine results to encourage clicks.',
  'Brainstorm and create a list of potential blog post topics for a business based on their niche and target audience.',
  'Verify the accuracy of facts, statistics, and sources cited in news articles or blog posts before publication.',
  'Create accurate and synchronized subtitles for internal corporate training videos or town hall meetings.',
  // Simple Web & IT Support (15)
  'Make minor changes to a WordPress website\'s appearance, such as changing colors or fonts, using the theme customizer.',
  'Set up specific goals in Google Analytics, like tracking form submissions or button clicks, to measure website performance.',
  'Test a website on different web browsers (Chrome, Firefox, Safari) and devices to ensure it looks and works correctly.',
  'Make basic changes to a domain\'s DNS records, such as pointing a domain to a new server or setting up email records.',
  'Help diagnose and resolve common email delivery problems, such as emails going to spam or not being received.',
  'Guide users step-by-step through setting up two-factor authentication on their accounts for better security.',
  'Provide first-level technical support by answering common questions and resolving simple issues via chat or email.',
  'Update articles and tutorials in an online knowledge base or help center with new information.',
  'Follow specific steps to reproduce reported software bugs and document the process clearly for developers.',
  'Assist users in migrating their files from one cloud storage service (e.g., Dropbox) to another (e.g., Google Drive).',
  'Test basic functionalities of mobile apps on iOS and Android devices and report any issues found.',
  'Record your screen to create simple, step-by-step video tutorials on how to perform a specific task.',
  'Use online tools to monitor a website for downtime and report any outages immediately.',
  'Use security plugins or online scanners to find and remove malware from simple WordPress websites.',
  'Guide users through the process of backing up their website files and database to prevent data loss.',
  // Beginner Marketing & Sales (15)
  'Create simple, reusable email templates for newsletters or marketing campaigns using tools like Mailchimp.',
  'Build lists of potential websites for outreach campaigns, including contact information and website metrics.',
  'Assist in managing a small affiliate network by tracking sales, onboarding new affiliates, and providing support.',
  'Research and identify influencers in a specific niche who might be a good fit for brand collaborations.',
  'Monitor the social media ads of competitor brands and compile a report on their strategies and messaging.',
  'Help set up product catalogs on social media platforms like Facebook Shops or Instagram Shopping.',
  'Participate in niche online communities and forums to build brand awareness and engage with potential customers.',
  'Help set up and monitor simple A/B tests for landing page headlines or calls-to-action.',
  'Reach out to customers to request and collect positive testimonials and reviews for a business.',
  'Submit a company\'s blog posts and articles to social bookmarking websites to generate backlinks and traffic.',
  'Review inbound leads and qualify them based on a set of predefined criteria before passing them to the sales team.',
  'Assist with the technical setup and promotion of webinars, including creating registration pages and sending reminders.',
  'Create and manage simple online polls and surveys to gather market research or customer feedback.',
  'Use Google Alerts to monitor mentions of a brand, competitors, or industry keywords online.',
  'Manually submit a business\'s information to local online directories to improve their local SEO.',
  // Virtual Community & Support (15)
  'Review and moderate user-submitted comments on a blog to filter out spam and inappropriate content.',
  'Manage a Facebook group by approving or denying new member requests and posts based on group rules.',
  'Send a welcome message to new members of an online forum or community to make them feel included.',
  'Answer common questions and provide support to users in a brand\'s Discord server.',
  'Host a weekly "Ask Me Anything" (AMA) or discussion thread on a relevant subreddit to engage the community.',
  'Identify and report spam, trolling, and abusive behavior in online communities to maintain a safe environment.',
  'Encourage community members to participate in online events, challenges, or discussions.',
  'Collect and organize feedback, suggestions, and feature requests from the community for product improvement.',
  'Host virtual social events, like online coffee chats or happy hours, for a remote team or community.',
  'Create a "Member of the Week" feature to highlight active and valuable community members.',
  'Help create, communicate, and enforce the rules and guidelines for an online community.',
  'Facilitate online support groups for specific topics, ensuring a safe and supportive environment.',
  'Provide peer-to-peer support in online communities, helping other users with their questions and issues.',
  'Organize and host virtual game nights or social activities for an online community or team.',
  'Find and share interesting and relevant articles, news, or resources within an online community.',
  // Entry-Level Creative Gigs (15)
  'Create simple animated logos for businesses or YouTubers using easy-to-use online animation tools.',
  'Design printable planners, checklists, and trackers for personal or professional use and sell them online.',
  'Create beautiful photo collages for special occasions like birthdays, anniversaries, or weddings.',
  'Customize social media templates (e.g., for Instagram posts or stories) with a client\'s branding and content.',
  'Find high-quality stock photos for presentations, blog posts, or social media content.',
  'Create basic infographics to visualize data or explain concepts using template-based tools like Canva.',
  'Design custom end screens for YouTube videos to promote other videos or social media channels.',
  'Create simple, repeating pattern designs that can be used for fabrics, wrapping paper, or digital backgrounds.',
  'Design custom emojis for use in Discord servers or Slack workspaces.',
  'Write short, catchy jingles or advertising slogans for small businesses or products.',
  'Perform basic sound editing tasks, such as reducing background noise or normalizing volume levels in audio files.',
  'Create animated GIFs from short video clips for use on social media or in marketing materials.',
  'Design custom digital greeting cards for holidays, birthdays, or other special occasions.',
  'Use AI tools or software to colorize old black and white photographs for clients.',
  'Create and curate long-form lo-fi music mixes for YouTube or Spotify, suitable for studying or relaxation.',
  // Micro E-commerce & Retail (15)
  'Source products for e-commerce stores from wholesale websites like Alibaba or 1688, based on client criteria.',
  'Write keyword-rich and descriptive titles for Etsy products to improve their visibility in search results.',
  'Optimize product listings on Amazon by improving titles, bullet points, descriptions, and backend keywords.',
  'Handle customer returns and exchanges for online stores, ensuring a smooth and positive customer experience.',
  'Monitor and manage inventory levels across multiple e-commerce platforms to prevent overselling.',
  'Create attractive product bundles and promotional offers to increase the average order value.',
  'Respond to customer reviews and feedback on e-commerce platforms in a professional and timely manner.',
  'Find and collaborate with reliable dropshipping suppliers for an online store.',
  'Plan and execute flash sales and promotional campaigns to drive sales and clear inventory.',
  'Set up and manage a wishlist or gift registry feature on an e-commerce website.',
  'Process and fulfill orders from a Shopify store, including managing shipping and tracking information.',
  'Research and identify profitable niche markets for new e-commerce ventures.',
  'Set up cross-selling and upselling recommendations on an e-commerce store to increase sales.',
  'Manage a customer loyalty program by tracking points, issuing rewards, and engaging with members.',
  'Analyze abandoned cart data to identify issues in the checkout process and implement improvements.',
  // Personal & Admin Assistance (15)
  'Organize and tag large collections of digital photos for individuals or families for easy access.',
  'Manage personal calendars by scheduling appointments, setting reminders, and organizing daily tasks.',
  'Transcribe personal audio notes, voice memos, or dictated thoughts into text documents.',
  'Research and book flights, accommodations, and activities for a client\'s personal or business travel.',
  'Manage personal email inboxes by filtering spam, organizing messages, and responding to basic inquiries.',
  'Help individuals create and manage their household budgets to track expenses and savings.',
  'Assist with online grocery shopping by creating shopping lists and placing orders for delivery.',
  'Find and hire local service providers, such as plumbers or electricians, for a client online.',
  'Keep track of and manage a client\'s various digital subscriptions and memberships.',
  'Help a client pay their personal bills online and set up reminders for due dates.',
  'Organize a client\'s digital documents and files into a logical and easy-to-navigate folder structure.',
  'Assist with planning and coordinating personal events like birthday parties or family gatherings.',
  'Arrange for gifts and cards to be sent to a client\'s friends and family on special occasions.',
  'Proofread a client\'s personal emails, letters, or documents for spelling and grammar errors.',
  'Create personalized "how-to" guides or instructions for a client\'s family members on using new technology.',
];
...
const remoteHustlesBatch10 = generateHustles(120, generalHustles.length + remoteHustlesBatch1.length + remoteHustlesBatch2.length + remoteHustlesBatch3.length + remoteHustlesBatch4.length + remoteHustlesBatch5.length + remoteHustlesBatch6.length + remoteHustlesBatch7.length + remoteHustlesBatch8.length + remoteHustlesBatch9.length, remoteCategoriesBatch10, remoteSampleTitlesBatch10, remoteSampleDescriptionsBatch10, true);
