...
import { Info, Menu as MenuIcon, FileText, Shield, Bookmark as BookmarkIcon, Sparkles } from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-3">
          ...
          <nav className="flex items-center space-x-1 sm:space-x-2">
            <Button variant="ghost" asChild className="text-primary-foreground hover:bg-primary/80 hover:text-primary-foreground px-2 py-1 sm:px-3 h-auto text-xs sm:text-sm">
             ...
             <Button variant="ghost" asChild className="text-primary-foreground hover:bg-primary/80 hover:text-primary-foreground px-2 py-1 sm:px-3 h-auto text-xs sm:text-sm">
              <Link href="/skill-matcher" className="flex items-center space-x-1">
