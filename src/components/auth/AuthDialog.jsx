      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            Sign in to save your favorite hustles and track your progress across devices.
          </DialogDescription>
        </DialogHeader>
        <div className="py-4">
          <Button
            ...
            disabled={isLoading}
            className="w-full h-12 text-lg bg-white text-gray-800 border border-gray-300 hover:bg-gray-50"
          >
            {isLoading ? (
